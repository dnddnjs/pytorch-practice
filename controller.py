...
class Controller(nn.Module):
    ...
    def sample_child(self):
        ...
        normal_arc, reduction_arc = list(), list()
        # entropy and log prob is for the training of controller
        entropy_list, log_prob_list = list(), list()

        # sample normal architecture
        outputs = self.sample_cell(normal_arc, entropy_list, log_prob_list, False)
        normal_arc, entropy_list, log_prob_list = outputs

        # sample reduction architecture
        outputs = self.sample_cell(reduction_arc, entropy_list, log_prob_list, False)
